...
export default function Questionaire() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "topic-header", ref: headerRef, children: _jsx(HeaderArea, { currentPage: currentPage, progressPages: progressPages, qLength: questionaire.info.length }) }), _jsx("div", { className: "page-narrow", id: "topic-page-container", ref: topicPageRef, children: _jsx("div", { className: "page-container", children: questionaire.info.map((page) => {
                        return (_jsx("div", { className: `page page-width ${currentPage.id === page.id ? 'active' : ''}`, id: `page${page.id}`, children: _jsx(Page, { page: page, next: next, back: back, currentPage: currentPage }) }, page.id));
                    }) }) })] }));
}
